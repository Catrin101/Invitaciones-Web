/**
 * sections.js — Template XV Elegante
 * Renderizadores específicos para el template de XV años
...
export function renderFooter(footer) {
  ...
  el.innerHTML = `
    <p class="footer__message">${footer.message}</p>
    <p class="footer__brand">
      Hecho con ♥ por
      <a href="${footer.brandUrl}" target="_blank" rel="noopener">${footer.brand}</a>
    </p>
  `;
}
